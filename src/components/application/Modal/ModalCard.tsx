...
interface ModalCardBodyTech {
  isToggleModalBodyTech: boolean;
  onToggleModalBodyTech: () => void;
}

export function ModalCardBodyTech({
  isToggleModalBodyTech,
  onToggleModalBodyTech,
}: ModalCardBodyTech) {
  return (
    <div
      className={`${
        isToggleModalBodyTech ? 'opacity-100 visible' : 'opacity-0 invisible'
